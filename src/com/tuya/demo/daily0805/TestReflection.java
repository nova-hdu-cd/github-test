...
public class TestReflection {
    ...
    public static void main(String[] args)
        ...
        Class<Solution> clazz1 = (Class<Solution>) Class.forName("com.tuya.demo.daily0805.Solution");
        Class<Solution> clazz2 = Solution.class;
        Solution solution = new Solution();
        Class<? extends Solution> clazz3 = solution.getClass();
        System.out.println(clazz1 == clazz2);
        System.out.println(clazz2 == clazz3);

        getAllFields("com.tuya.demo.daily0723.Son");
